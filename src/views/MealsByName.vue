    ...
    <div v-for="meal of meals" :key="meal.idMeal" class="bg-white shadow rounded-xl">
      ...
      <div class="px-3">
        ...
        <div class=" py-2 flex items-center justify-between px-10">
          <a :href="meal.strYoutube" target="_blank" class="px-3 py-2 rounded border-2 border-red-500  bg-red-500 hover:bg-red-600 text-white transition-colors">
            Video
          </a>
          <router-link to="/" class="px-3 py-2 rounded border-2 border-blue-500  bg-blue-500 hover:bg-blue-600 text-white transition-colors">
            View
          </router-link>
        </div>
      </div>
